...
A group is *separated* when its members carry distinct signatures, and left on
the *ordinal* when they do not. Per-language tallies matter as much as the
...
def report_collisions(root: Path) -> CollisionReport:
    """Count collision groups under ``root``, classified by signature."""
