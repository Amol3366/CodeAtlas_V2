...
- **Settings provider panels** - the Settings route uses summary panels,
  ...
  grouped but kept operational: save settings, test provider, and download an
  Ollama model remain distinct actions with their own loading and error states.
